...
export default function Home() {
    ...
    // ボタンの項目リスト
    const family_member = ["ご本人", "ご夫婦", "ご夫婦+お子様1人", "ご夫婦+お子様2人以上", "親子", "ご本人+ご両親"]
    const life_plan = ["旅行", "趣味", "車", "生涯学習", "こどもの教育費", "こども・孫への援助", "仕事・ボランティア", "住宅購入・リフォーム"]
    const savings = ["300万円", "500万円", "800万円", "1,000万円", "2,000万円", "3,000万円", "5,000万円", "5,000万円以上"]
    const annual_income = ["0万円", "100万円","300万円", "500万円", "800万円", "1,000万円", "2,000万円", "3,000万円以上"]
    const annual_income_spouse = ["0万円", "100万円","300万円", "500万円", "800万円", "1,000万円", "2,000万円", "3,000万円以上"]
    const monthly_consumption = ["10万円", "20万円", "30万円", "40万円", "50万円", "60万円", "70万円", "80万円以上"]
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-12 gap-4">
            ...
            <button className='btn bg-blue-800 text-white mx-auto w-4/5 mb-5'>結果を見る</button>
