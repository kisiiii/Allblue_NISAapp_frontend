...
export function RankingCard_intro({ rank, fundName, price, priceChange }) {
  return (
    <div className="flex w-full gap-1.5 items-stretch">
      ...
      <div className="flex-1 flex flex-col gap-1">
        ...
        <div className="flex gap-1.5 items-center">
          ...
          {/* 積立ボタン */}
          <button
            className="px-6 py-3 bg-gray-400 text-white text-xs font-bold rounded-3xl min-w-[80px] md:w-[140px]"
            aria-label="積立ボタン"
          >
            積立
          </button>
...
export default RankingCard_intro;